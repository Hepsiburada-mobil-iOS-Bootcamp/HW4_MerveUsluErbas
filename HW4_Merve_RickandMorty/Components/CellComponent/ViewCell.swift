...
//            cellInfo.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 10),
//
//            cellInfo.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -10),
//
//            cellInfo.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: 10),
//
//            cellInfo.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -10),
